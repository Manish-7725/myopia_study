...
urlpatterns = [
    ...
    path("admin/export/students/csv/", api_admin.export_students_csv),
    path("admin/export/students/excel/", api_admin.export_students_excel),
    path("admin/followups/", api_admin.admin_followups),
    path("admin/followups/create/", api_admin.create_followup),
